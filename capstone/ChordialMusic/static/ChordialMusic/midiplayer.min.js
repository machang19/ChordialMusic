    ...
    return function() {
        ...
        1: [function(t, e, r) {
            ...
            r.toByteArray = function(t) {
                ...
                for (e = 0; e < r; e += 4)
                    ...
                    a[f++] = n >> 8 & 255,
                    a[f++] = 255 & n;
                2 === o ? (n = i[t.charCodeAt(e)] << 2 | i[t.charCodeAt(e + 1)] >> 4,
                a[f++] = 255 & n) : 1 === o && (n = i[t.charCodeAt(e)] << 10 | i[t.charCodeAt(e + 1)] << 4 | i[t.charCodeAt(e + 2)] >> 2,
                a[f++] = n >> 8 & 255,
                a[f++] = 255 & n);
                return a
            }
            ...
            r.fromByteArray = function(t) {
                for (var e, r = t.length, i = r % 3, s = "", o = [], a = 16383, u = 0, h = r - i; u < h; u += a)
                    o.push(f(t, u, u + a > h ? h : u + a));
                1 === i ? (e = t[r - 1],
                s += n[e >> 2],
                s += n[e << 4 & 63],
                s += "==") : 2 === i && (e = (t[r - 2] << 8) + t[r - 1],
                s += n[e >> 10],
                s += n[e >> 4 & 63],
                s += n[e << 2 & 63],
                s += "=");
        ...
        2: [function(t, e, r) {
            ...
            function u(t, e, r) {
                ...
                return D(t) ? function(t, e, r) {
                    ...
                    if (t) {
                        if (O(t) || "length"in t)
                            return "number" != typeof t.length || R(t.length) ? o(0) : c(t);
            ...
            function g(t, e, r, n, i) {
                ...
                if ("number" == typeof e)
                    return e &= 255,
                    "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(t, e, r) : Uint8Array.prototype.lastIndexOf.call(t, e, r) : d(t, [e], r, n, i);
                throw new TypeError("val must be string, number or Buffer")
            }
            function d(t, e, r, n, i) {
                var s, o = 1, a = t.length, u = e.length;
            ...
            function w(t, e, r) {
                ...
                for (var n = [], i = e; i < r; ) {
                    var s, o, a, u, h = t[i], f = null, c = h > 239 ? 4 : h > 223 ? 3 : h > 191 ? 2 : 1;
                    if (i + c <= r)
                        switch (c) {
                        case 1:
                            h < 128 && (f = h);
                        ...
                        case 3:
                            s = t[i + 1],
                            o = t[i + 2],
                            128 == (192 & s) && 128 == (192 & o) && (u = (15 & h) << 12 | (63 & s) << 6 | 63 & o) > 2047 && (u < 55296 || u > 57343) && (f = u);
                            break;
                        case 4:
                            s = t[i + 1],
                            o = t[i + 2],
                            a = t[i + 3],
                            128 == (192 & s) && 128 == (192 & o) && 128 == (192 & a) && (u = (15 & h) << 18 | (63 & s) << 12 | (63 & o) << 6 | 63 & a) > 65535 && u < 1114112 && (f = u)
                        }
                    null === f ? (f = 65533,
                    c = 1) : f > 65535 && (f -= 65536,
            ...
            a.alloc = function(t, e, r) {
                ...
                s = r,
                h(n = t),
                n <= 0 ? o(n) : void 0 !== i ? "string" == typeof s ? o(n).fill(i, s) : o(n).fill(i) : o(n);
                var n, i, s
            }
            ,
            ...
            a.prototype.compare = function(t, e, r, n, i) {
                ...
                if (this === t)
                    return 0;
                for (var s = (i >>>= 0) - (n >>>= 0), o = (r >>>= 0) - (e >>>= 0), u = Math.min(s, o), h = this.slice(n, i), f = t.slice(e, r), c = 0; c < u; ++c)
                    if (h[c] !== f[c]) {
                        s = h[c],
                        o = f[c];
                        break
        ...
        3: [function(t, e, r) {
            r.read = function(t, e, r, n, i) {
                var s, o, a = 8 * i - n - 1, u = (1 << a) - 1, h = u >> 1, f = -7, c = r ? i - 1 : 0, l = r ? -1 : 1, p = t[e + c];
                for (c += l,
                s = p & (1 << -f) - 1,
                p >>= -f,
                f += a; f > 0; s = 256 * s + t[e + c],
                c += l,
                f -= 8)
                    ;
                for (o = s & (1 << -f) - 1,
                s >>= -f,
                f += n; f > 0; o = 256 * o + t[e + c],
                c += l,
                f -= 8)
                    ;
                if (0 === s)
            ...
            r.write = function(t, e, r, n, i, s) {
                var o, a, u, h = 8 * s - i - 1, f = (1 << h) - 1, c = f >> 1, l = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : s - 1, y = n ? 1 : -1, g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                for (e = Math.abs(e),
                isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0,
                o = f) : (o = Math.floor(Math.log(e) / Math.LN2),
                e * (u = Math.pow(2, -o)) < 1 && (o--,
                u *= 2),
                (e += o + c >= 1 ? l / u : l * Math.pow(2, 1 - c)) * u >= 2 && (o++,
                u /= 2),
                o + c >= f ? (a = 0,
                o = f) : o + c >= 1 ? (a = (e * u - 1) * Math.pow(2, i),
                o += c) : (a = e * Math.pow(2, c - 1) * Math.pow(2, i),
                o = 0)); i >= 8; t[r + p] = 255 & a,
                p += y,
                a /= 256,
                i -= 8)
        ...
        4: [function(t, e, r) {
            ...
            }, i = [["C"], ["C#", "Db"], ["D"], ["D#", "Eb"], ["E"], ["F"], ["F#", "Gb"], ["G"], ["G#", "Ab"], ["A"], ["A#", "Bb"], ["B"]], s = 0, o = function(t) {
        ...
        6: [function(t, e, r) {
            ...
            var a = function() {
                ...
                return i(e, [{
                    ...
                    value: function(e) {
                        var r = t("fs");
                        return this.buffer = r.readFileSync(e),
                        this.fileLoaded()
                    }
                }, {
                    key: "loadArrayBuffer",
                    ...
                    key: "loadDataUri",
                    value: function(t) {
                        for (var e = s.atob(t.split(",")[1]), r = new Uint8Array(e.length), n = 0; n < e.length; n++)
                            r[n] = e.charCodeAt(n);
                    ...
                    key: "getFormat",
                    value: function() {
                        return this.format = s.bytesToNumber(this.buffer.subarray(8, 10)),
                        this
                    }
                }, {
                    key: "getTracks",
                    value: function() {
                        ...
                        for (var t = 0; t < this.buffer.length; ) {
                            if ("MTrk" == s.bytesToLetters(this.buffer.subarray(t, t + 4))) {
                                ...
                                this.tracks.push(new o(this.tracks.length,this.buffer.subarray(t + 8, t + 8 + e)))
                            }
                    ...
                    key: "getDivision",
                    value: function() {
                        return this.division = s.bytesToNumber(this.buffer.subarray(12, 14)),
                        this
                    }
                }, {
                    key: "playLoop",
                    value: function(t) {
                        ...
                        this.tracks.forEach(function(e) {
                            if (!t && this.endOfFile())
                                ...
                                t && r ? (r.hasOwnProperty("name") && "Set Tempo" === r.name && this.setTempo(r.data),
                                r.hasOwnProperty("name") && "Program Change" === r.name && (this.instruments.includes(r.value) || this.instruments.push(r.value))) : r && this.emitEvent(r)
                            }
                        }, this),
                    ...
                    key: "endOfFile",
                    value: function() {
                        return this.isPlaying() ? this.eventsPlayed() == this.totalEvents : this.bytesProcessed() == this.buffer.length
                    }
                }, {
                    key: "getCurrentTick",
                    value: function() {
                ...
                return n(t, [{
                    ...
                    value: function() {
                        ...
                        255 == this.data[t]) {
                            ...
                            case 81:
                                e.name = "Set Tempo",
                                e.data = Math.round(6e7 / s.bytesToNumber(this.data.subarray(t + 3, t + 6))),
                                this.tempo = e.data;
                                break;
                            case 84:
                                e.name = "SMTPE Offset";
                            ...
                            case 89:
                                ...
                                e.data[0] >= 0 ? e.keySignature = i.CIRCLE_OF_FIFTHS[e.data[0]] : e.data[0] < 0 && (e.keySignature = i.CIRCLE_OF_FOURTHS[Math.abs(e.data[0])]),
                                0 == e.data[1] ? e.keySignature += " Major" : 1 == e.data[1] && (e.keySignature += " Minor");
                                break;
                            case 127:
                            ...
                            this.data[t] < 128 ? (e.running = !0,
                            e.noteNumber = this.data[t],
                            e.noteName = i.NOTES[this.data[t]],
                            e.velocity = this.data[t + 1],
                            this.lastStatus <= 143 ? (e.name = "Note off",
                            e.channel = this.lastStatus - 128 + 1) : this.lastStatus <= 159 && (e.name = "Note on",
                            e.channel = this.lastStatus - 144 + 1),
                            this.pointer += r + 2) : (this.lastStatus = this.data[t],
                            this.data[t] <= 143 ? (e.name = "Note off",
                            ...
                            this.pointer += r + 3) : this.data[t] <= 159 ? (e.name = "Note on",
                            e.channel = this.lastStatus - 144 + 1,
                            e.noteNumber = this.data[t + 1],
                            e.noteName = i.NOTES[this.data[t + 1]],
                            e.velocity = Math.round(this.data[t + 2] / 127 * 100),
                            this.pointer += r + 3) : this.data[t] <= 175 ? (e.name = "Polyphonic Key Pressure",
                            e.channel = this.lastStatus - 160 + 1,
                            e.note = i.NOTES[this.data[t + 1]],
                            e.pressure = event[2],
                            this.pointer += r + 3) : this.data[t] <= 191 ? (e.name = "Controller Change",
                            e.channel = this.lastStatus - 176 + 1,
                            e.number = this.data[t + 1],
                            e.value = this.data[t + 2],
                            this.pointer += r + 3) : this.data[t] <= 207 ? (e.name = "Program Change",
                            e.channel = this.lastStatus - 192 + 1,
                            e.value = this.data[t + 1],
                            this.pointer += r + 2) : this.data[t] <= 223 ? (e.name = "Channel Key Pressure",
                            e.channel = this.lastStatus - 208 + 1,
                            this.pointer += r + 2) : this.data[t] <= 239 ? (e.name = "Pitch Bend",
                            e.channel = this.lastStatus - 224 + 1,
                            this.pointer += r + 3) : e.name = "Unknown.  Pointer: " + this.pointer.toString() + " " + t.toString() + " " + this.data.length);
